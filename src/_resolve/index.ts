...
import type { Shift, ShiftUntil, TuplifyUnion } from "../utilities/common";
import type { Int } from "../utilities/maths";
import type { DIRECTION, Message, Room } from "../_player"
...
export type ResolveRoomName<TPlayer extends Player> = Player.GetHistory<TPlayer> extends Room ? Player.GetHistory<TPlayer>['name'] : never
...
type ResolveMessage<TData extends Message> = TData extends Message ? ResolveResponse<TData> : Errors.RESOLVE_MESSAGE_ERROR
...
> =
  ResolveResponse<TFirst> extends Message
    ? ResolveMessage<TFirst extends Message ? TFirst : never> 
    : ResolveRoom<TPlayer>
